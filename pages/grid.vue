...
export default {
  ...
  data() {
    return {
      items: [{
          season: 'Spring:',
          months: 'March 1-May 31',
          hours: 'Hours: Everyday, 10 a.m.-7 p.m.'
        },
        {
          season: 'Summer:',
          months: 'June 1-Aug. 31',
          hours: 'Hours: Everyday, 8 a.m.-9 p.m.'
        },
        {
          season: 'Fall:',
          months: 'Sep. 1-Nov. 30',
          hours: 'Hours: W-Sun, 10 a.m.-7 p.m. (Closed Monday & Tuesday)'
        },
        {
          season: 'Winter',
          months: 'Dec. 1-Feb. 28',
          hours: 'Hours: W-Sun, noon-7 p.m. (Closed Monday & Tuesday)'
        },
      ],
    }
  }
